...
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/ReconInfoSec/62-sysmon/master/auto_update.bat','C:\ProgramData\sysmon\auto_update.bat')"
